...
//  CalculatorApp
//
//  Created by Masaaki Matsunaga on 2017/09/03.
//  Copyright © 2017年 Masaaki Matsunaga. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Empty the labels of answer and equation
    ...
    @IBAction func inputFormula(_ sender: UIButton) {
        //Show equation when button be pushed
        //Exception Clear and equal
    ...
    @IBAction func clearCalculation(_ sender: UIButton) {
        //Clear equation and answer when C button be pushed
    ...
    @IBAction func calculateAnswer(_ sender: UIButton) {
        // Calculate and display the answer if  = button be pushed
        guard let formulaText = formulaLabel.text else{
            return
        }
